         ...
         <div className="flex py-8 gap-[4rem] px-7">
            ...
            <div className="flex w-[60%] gap-7">
               <div className="flex flex-col gap-4">
                  ...
                  <p className="text-[0.875rem] py-1 hover:underline">
            ...
            <div className="w-[30%]">
               ...
               <div className="flex">
                  <input
                     ...
                     name="email"
                     id="email"
                     className="w-full p-3 text-[0.875rem] py-1 hover:underline duration-200 border-gray-300 shadow-input focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-300 focus:border-r-0 rounded-l-lg"
